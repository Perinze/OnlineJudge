    ...
    export default {
        ...
        data(){
            return {
                items: [
                    { title: 'Dijkstra算法',
                      desc: 'Here is the description of the algorithm. Here is the description of the algorit hm.Here is the description of thedescrption of the aigorithm.Here is the descri ption of thedescrption of the aigorithm.Here is the description of thedescrption of the aigorithm.'
                    },
                    {
