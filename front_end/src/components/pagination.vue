<template>
  <div class="pagination" v-if="total - pageSize > 0 && total - 0 > 0">
    ...
    <div class="pagination-block" style="cursor: auto" v-if="isShowPrevMore">
      ···
    </div>
    <div
      :class="[
        'pagination-block',
        item == index ? 'pagination-block-active' : '',
      ]"
    ...
    <div class="pagination-block" style="cursor: auto" v-if="isShowNextMore">
      ···
    </div>
    <div
      :class="[
        'pagination-block',
        pageNum.length == index ? 'pagination-block-active' : '',
      ]"
